...
/**
 * @brief Support for anonymous structures
 */
#if defined ( __CC_ARM )
...
#define __MPU_PRESENT               0U  /*!< MC60FXXXX do not provide MPU                  */
#define __NVIC_PRIO_BITS            2U  /*!< MC60FXXXX uses 2 Bits for the Priority Levels */
...
/******  MS32F0 specific Interrupt Numbers *******************************************************************/
  WWDG_IRQn                   = 0,      /*!< Window WatchDog Interrupt                                       */
  PVD_IRQn                    = 1,      /*!< PVD Interrupt through EXTI Lines 16                             */
  RTC_IRQn                    = 2,      /*!< RTC Interrupt through EXTI Lines 17, 19                         */
  ...
  ADC1_COMP_IRQn              = 12,     /*!< ADC1 and CMP1/2 Interrupt                                       */
...
#include "system_ms32f0xx.h"    /* MC60FXXXX System Header */
#include <stdint.h>


/* Exported types ------------------------------------------------------------*/
/**
  * @brief TIM(include TIM2  0x4000 0000 - 0x4000 03FF
  *                    TIM3  0x4000 0400 - 0x4000 07FF
  *                    TIM14 0x4000 2000 - 0x4000 23FF
  *                    TIM1  0x4001 2C00 - 0x4001 2FFF
  *                    TIM16 0x4001 4400 - 0x4001 47FF
  *                    TIM17 0x4001 4800 - 0x4001 4BFF)
  */
typedef struct {
  __IO uint32_t CEN               :  1;
...
typedef struct {
  __IO uint32_t TI1_RMP           :  2;
  __IO uint32_t RES1              : 30;
} TIM_OR_32Bit;
...
typedef struct {
  union {
    ...
    TIM_CR1_32Bit CR1_BIT;
  };
  union {
    __IO uint32_t CR2;          /*!< TIM control register 2,                      Address offset: 0x04 */
    TIM_CR2_32Bit CR2_BIT;
  };
  union {
    __IO uint32_t SMCR;         /*!< TIM slave Mode Control register,             Address offset: 0x08 */
    TIM_SMCR_32Bit SMCR_BIT;
  };
  union {
    __IO uint32_t DIER;         /*!< TIM DMA/interrupt enable register,           Address offset: 0x0C */
    TIM_DIER_32Bit DIER_BIT;
  };
  union {
  ...
  union {
    ...
    TIM_EGR_32Bit EGR_BIT;
  };
  union {
    __IO uint32_t CCMR1;        /*!< TIM capture/compare mode register 1,         Address offset: 0x18 */
    TIM_CCMR1_OC_32Bit CCMR1_OC_BIT;
    TIM_CCMR1_IC_32Bit CCMR1_IC_BIT;
  };
  union {
    __IO uint32_t CCMR2;        /*!< TIM capture/compare mode register 2,         Address offset: 0x1C */
    TIM_CCMR2_OC_32Bit CCMR2_OC_BIT;
    TIM_CCMR2_IC_32Bit CCMR2_IC_BIT;
  };
  union {
    __IO uint32_t CCER;         /*!< TIM capture/compare enable register,         Address offset: 0x20 */
    TIM_CCER_32Bit CCER_BIT;
  };
    __IO uint32_t CNT;          /*!< TIM counter register,                        Address offset: 0x24 */
  union {
    __IO uint32_t PSC;          /*!< TIM prescaler register,                      Address offset: 0x28 */
    TIM_PSC_32Bit PSC_BIT;
  };
    __IO uint32_t ARR;          /*!< TIM auto-reload register,                    Address offset: 0x2C */
  union {
    __IO uint32_t RCR;          /*!< TIM  repetition counter register,            Address offset: 0x30 */
    TIM_RCR_32Bit RCR_BIT;
  };
  ...
  union {
    ...
    TIM_BDTR_32Bit BDTR_BIT;
  };
  union {
    __IO uint32_t DCR;          /*!< TIM DMA control register,                    Address offset: 0x48 */
    TIM_DCR_32Bit DCR_BIT;
  };
  union {
    __IO uint32_t DMAR;         /*!< TIM DMA address for full transfer register,  Address offset: 0x4C */
    TIM_DMAR_32Bit DMAR_BIT;
  };
  union {
...
/**
  * @brief Real-Time Clock(include RTC  0x4000 2800 - 0x4000 2BFF)
  */
typedef struct {
  __IO uint32_t SU                :  4;
  __IO uint32_t ST                :  3;
...
typedef struct {
  ...
  __IO uint32_t YU                :  4;
  __IO uint32_t YT                :  4;
  __IO uint32_t RES2              :  8;
} RTC_DR_32Bit;

typedef struct {
  __IO uint32_t RES1              :  3;
  __IO uint32_t TSEDGE            :  1;
  __IO uint32_t PEFCKON           :  1;
...
typedef struct {
  ...
  __IO uint32_t RECALPE           :  1;
  __IO uint32_t RES3              : 15;
} RTC_ISR_32Bit;
...
typedef struct {
  ...
  union {
    ...
    RTC_ISR_32Bit ISR_BIT;
  };
  union {
    __IO uint32_t PRER;          /*!< RTC prescaler register,                                    Address offset: 0x10 */
    RTC_PRER_32Bit PRER_BIT;
  };
  union {
    __IO uint32_t WUTR;          /*!< RTC wakeup timer register,                                 Address offset: 0x14 */
    RTC_WUTR_32Bit WUTR_BIT;
  };
         uint32_t RESERVED1;     /*!< Reserved,                                                  Address offset: 0x18 */
  union {
    __IO uint32_t ALRMAR;        /*!< RTC alarm A register,                                      Address offset: 0x1C */
    RTC_ALRMAR_32Bit ALRMAR_BIT;
  };
         uint32_t RESERVED2;     /*!< Reserved,                                                  Address offset: 0x20 */
  union {
    __IO uint32_t WPR;           /*!< RTC write protection register,                             Address offset: 0x24 */
    RTC_WPR_32Bit WPR_BIT;
  };
  union {
    __IO uint32_t SSR;           /*!< RTC sub second register,                                   Address offset: 0x28 */
    RTC_SSR_32Bit SSR_BIT;
  };
  union {
    __IO uint32_t SHIFTR;        /*!< RTC shift control register,                                Address offset: 0x2C */
    RTC_SHIFTR_32Bit SHIFTR_BIT;
  };
  union {
    __IO uint32_t TSTR;          /*!< RTC time stamp time register,                              Address offset: 0x30 */
    RTC_TR_32Bit TSTR_BIT;
  };
  union {
    __IO uint32_t TSDR;          /*!< RTC time stamp date register,                              Address offset: 0x34 */
    RTC_DR_32Bit TSDR_BIT;
  };
  union {
    __IO uint32_t TSSSR;         /*!< RTC time-stamp sub second register,                        Address offset: 0x38 */
    RTC_SSR_32Bit TSSSR_BIT;
  };
  union {
    __IO uint32_t CALR;          /*!< RTC calibration register,                                  Address offset: 0x3C */
    RTC_CALR_32Bit CALR_BIT;
  };
  union {
    __IO uint32_t TAFCR;         /*!< RTC tamper and alternate function configuration register,  Address offset: 0x40 */
    RTC_TAFCR_32Bit TAFCR_BIT;
  };
  union {
    __IO uint32_t ALRMASSR;      /*!< RTC alarm A sub second register,                           Address offset: 0x44 */
    RTC_ALRMASSR_32Bit ALRMASSR_BIT;
  };
...
/**
  * @brief Window WATCHDOG(include WWDG  0x4000 2C00 - 0x4000 2FFF)
  */
typedef struct {
  __IO uint32_t T                 :  7;
  __IO uint32_t WDGA              :  1;
  __IO uint32_t RES1              : 24;
} WWDG_CR_32BIT;

typedef struct {
  __IO uint32_t W                 :  7;
  __IO uint32_t WDGTB             :  2;
  __IO uint32_t EWI               :  1;
  __IO uint32_t RES1              : 22;
} WWDG_CFR_32BIT;

typedef struct {
  __IO uint32_t EWIF              :  1;
...
typedef struct {
  union {
    ...
    WWDG_CR_32BIT CR_BIT;
  };
  union {
    __IO uint32_t CFR;  /*!< WWDG Configuration register, Address offset: 0x04 */
    WWDG_CFR_32BIT CFR_BIT;
  };
  union {
    __IO uint32_t SR;   /*!< WWDG Status register,        Address offset: 0x08 */
    WWDG_SR_32BIT SR_BIT;
  };
} WWDG_TypeDef;


/**
  * @brief Independent WATCHDOG(include IWDG  0x4000 3000 - 0x4000 33FF)
  */
typedef struct {
...
typedef struct {
  __IO uint32_t PR                :  3;
  __IO uint32_t RES1              : 29;
} IWDG_PR_32BIT;

typedef struct {
  __IO uint32_t RL                : 12;
  __IO uint32_t RES1              : 20;
} IWDG_RLR_32BIT;
...
typedef struct {
  union {
    ...
    IWDG_KR_32BIT KR_BIT;
  };
  union {
    __IO uint32_t PR;    /*!< IWDG Prescaler register, Address offset: 0x04 */
    IWDG_PR_32BIT PR_BIT;
  };
  union {
    __IO uint32_t RLR;   /*!< IWDG Reload register,    Address offset: 0x08 */
    IWDG_RLR_32BIT RLR_BIT;
  };
  union {
    __IO uint32_t SR;    /*!< IWDG Status register,    Address offset: 0x0C */
    IWDG_SR_32BIT SR_BIT;
  };
  union {
    __IO uint32_t WINR;  /*!< IWDG Window register,    Address offset: 0x10 */
    IWDG_WINR_32BIT WINR_BIT;
  };
} IWDG_TypeDef;


/**
  * @brief Inter-integrated Circuit Interface(include I2C  0x4000 5400 - 0x4000 57FF)
  */
typedef struct {
  __IO uint32_t PE                :  1;
...
typedef struct {
  ...
  __IO uint32_t RES1              :  5;
} I2C_CR2_32BIT;

typedef struct {
  __IO uint32_t OA1               : 10;
...
typedef struct {
  ...
  __IO uint32_t TIMOUTCF          :  1;
  __IO uint32_t ALERTCF           :  1;
  __IO uint32_t RES3              : 18;
} I2C_ICR_32BIT;
...
typedef struct {
  union {
    ...
    I2C_CR1_32BIT CR1_BIT;
  };
  union {
    __IO uint32_t CR2;      /*!< I2C Control register 2,             Address offset: 0x04 */
    I2C_CR2_32BIT CR2_BIT;
  };
  union {
    __IO uint32_t OAR1;     /*!< I2C Own address 1 register,         Address offset: 0x08 */
    I2C_OAR1_32BIT OAR1_BIT;
  };
  union {
    __IO uint32_t OAR2;     /*!< I2C Own address 2 register,         Address offset: 0x0C */
    I2C_OAR2_32BIT OAR2_BIT;
  };
  union {
    __IO uint32_t TIMINGR;  /*!< I2C Timing register,                Address offset: 0x10 */
    I2C_TIMINGR_32BIT TIMINGR_BIT;
  };
  union {
    __IO uint32_t TIMEOUTR; /*!< I2C Timeout register,               Address offset: 0x14 */
    I2C_TIMEOUTR_32BIT TIMEOUTR_BIT;
  };
  union {
    __IO uint32_t ISR;      /*!< I2C Interrupt and status register,  Address offset: 0x18 */
    I2C_ISR_32BIT ISR_BIT;
  };
  union {
    __IO uint32_t ICR;      /*!< I2C Interrupt clear register,       Address offset: 0x1C */
    I2C_ICR_32BIT ICR_BIT;
  };
  union {
    __IO uint32_t PECR;     /*!< I2C PEC register,                   Address offset: 0x20 */
    I2C_PECR_32BIT PECR_BIT;
  };
  union {
    __IO uint32_t RXDR;     /*!< I2C Receive data register,          Address offset: 0x24 */
    I2C_DR_32BIT RXDR_BIT;
  };
  union {
    __IO uint32_t TXDR;     /*!< I2C Transmit data register,         Address offset: 0x28 */
    I2C_DR_32BIT TXDR_BIT;
  };
} I2C_TypeDef;


/**
  * @brief Power Control(include PWR  0x4000 7000 - 0x4000 73FF)
  */
typedef struct {
...
typedef struct {
  ...
  union {
    ...
    PWR_CSR_32BIT CSR_BIT;
  };
} PWR_TypeDef;


/**
  * @brief SysTem Configuration(include SYSCFG  0x4001 0000 - 0x4001 03FF)
  */
typedef struct {
  __IO uint32_t MEM_MODE          :  2;
  __IO uint32_t RES1              :  6;
  __IO uint32_t ADC_DMA_RMP       :  1;
  __IO uint32_t USART1_TX_DMA_RMP :  1;
  __IO uint32_t USART1_RX_DMA_RMP :  1;
  __IO uint32_t TIM16_DMA_RMP     :  1;
  __IO uint32_t TIM17_DMA_RMP     :  1;
  __IO uint32_t RES2              :  3;
  __IO uint32_t I2C_PB6_FMP       :  1;
  __IO uint32_t I2C_PB7_FMP       :  1;
  __IO uint32_t I2C_PB8_FMP       :  1;
  __IO uint32_t I2C_PB9_FMP       :  1;
  __IO uint32_t I2C1_FMP          :  1;
  __IO uint32_t RES3              :  1;
  __IO uint32_t I2C_PA9_FMP       :  1;
  __IO uint32_t I2C_PA10_FMP      :  1;
  __IO uint32_t RES4              :  8;
} SYSCFG_CFGR1_32BIT;

typedef struct {
  __IO uint32_t LOCKUP_LOCK       :  1;
  __IO uint32_t SRAM_PARITY_LOCK  :  1;
  __IO uint32_t PVD_LOCK          :  1;
  __IO uint32_t RES1              :  5;
  __IO uint32_t SRAM_REF          :  1;
  __IO uint32_t RES2              : 23;
} SYSCFG_CFGR2_32BIT;
...
typedef struct {
  union {
    ...
    SYSCFG_CFGR1_32BIT CFGR1_BIT;
  };
         uint32_t RESERVED1;   /*!< Reserved,                                                  Address offset: 0x04 */
    __IO uint32_t EXTICR[4];   /*!< SYSCFG external interrupt configuration register 1-4,      Address offset: 0x08-0x14 */
  union {
    __IO uint32_t CFGR2;       /*!< SYSCFG configuration register 2,                           Address offset: 0x18 */
    SYSCFG_CFGR2_32BIT CFGR2_BIT;
  };
} SYSCFG_TypeDef;


/**
  * @brief External Interrupt/Event Controller(include EXTI  0x4001 0400 - 0x4001 07FF)
  */
typedef struct {
  __IO uint32_t IM0               :  1;
  __IO uint32_t IM1               :  1;
  ...
  __IO uint32_t IM16              :  1;
  __IO uint32_t IM17              :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t IM19              :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t IM21              :  1;
  __IO uint32_t IM22              :  1;
  __IO uint32_t IM23              :  1;
  __IO uint32_t RES3              :  1;
  __IO uint32_t IM25              :  1;
  __IO uint32_t RES4              :  6;
} EXTI_IMR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t RT8               :  1;
  __IO uint32_t RT9               :  1;
  __IO uint32_t RT10              :  1;
  __IO uint32_t RT11              :  1;
  __IO uint32_t RT12              :  1;
  __IO uint32_t RT13              :  1;
  __IO uint32_t RT14              :  1;
  __IO uint32_t RT15              :  1;
  __IO uint32_t RT16              :  1;
  __IO uint32_t RT17              :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t RT19              :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t RT21              :  1;
  __IO uint32_t RT22              :  1;
  __IO uint32_t RES3              :  9;
} EXTI_RTSR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t FT8               :  1;
  __IO uint32_t FT9               :  1;
  __IO uint32_t FT10              :  1;
  __IO uint32_t FT11              :  1;
  __IO uint32_t FT12              :  1;
  __IO uint32_t FT13              :  1;
  __IO uint32_t FT14              :  1;
  __IO uint32_t FT15              :  1;
  __IO uint32_t FT16              :  1;
  __IO uint32_t FT17              :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t FT19              :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t FT21              :  1;
  __IO uint32_t FT22              :  1;
  __IO uint32_t RES3              :  9;
} EXTI_FTSR_32BIT;

typedef struct {
  __IO uint32_t SWI0              :  1;
  __IO uint32_t SWI1              :  1;
  __IO uint32_t SWI2              :  1;
  __IO uint32_t SWI3              :  1;
  __IO uint32_t SWI4              :  1;
  __IO uint32_t SWI5              :  1;
  __IO uint32_t SWI6              :  1;
  __IO uint32_t SWI7              :  1;
  __IO uint32_t SWI8              :  1;
  __IO uint32_t SWI9              :  1;
  __IO uint32_t SWI10             :  1;
  __IO uint32_t SWI11             :  1;
  __IO uint32_t SWI12             :  1;
  __IO uint32_t SWI13             :  1;
  __IO uint32_t SWI14             :  1;
  __IO uint32_t SWI15             :  1;
  __IO uint32_t SWI16             :  1;
  __IO uint32_t SWI17             :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t SWI19             :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t SWI21             :  1;
  __IO uint32_t SWI22             :  1;
  __IO uint32_t RES3              :  9;
} EXTI_SWIER_32BIT;
...
typedef struct {
  ...
  __IO uint32_t PIF6              :  1;
  __IO uint32_t PIF7              :  1;
  __IO uint32_t PIF8              :  1;
  __IO uint32_t PIF9              :  1;
  __IO uint32_t PIF10             :  1;
  __IO uint32_t PIF11             :  1;
  __IO uint32_t PIF12             :  1;
  __IO uint32_t PIF13             :  1;
  __IO uint32_t PIF14             :  1;
  __IO uint32_t PIF15             :  1;
  __IO uint32_t PIF16             :  1;
  __IO uint32_t PIF17             :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t PIF19             :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t PIF21             :  1;
  __IO uint32_t PIF22             :  1;
  __IO uint32_t RES3              :  9;
} EXTI_PR_32BIT;
...
typedef struct {
  union {
    ...
    EXTI_IMR_32BIT IMR_BIT;
  };
  union {
    __IO uint32_t EMR;          /*!<EXTI Event mask register,                     Address offset: 0x04 */
    EXTI_EMR_32BIT EMR_BIT;
  };
  union {
    __IO uint32_t RTSR;         /*!<EXTI Rising trigger selection register ,      Address offset: 0x08 */
    EXTI_RTSR_32BIT RTSR_BIT;
  };
  union {
    __IO uint32_t FTSR;         /*!<EXTI Falling trigger selection register,      Address offset: 0x0C */
    EXTI_FTSR_32BIT FTSR_BIT;
  };
  union {
    __IO uint32_t SWIER;        /*!<EXTI Software interrupt event register,       Address offset: 0x10 */
    EXTI_SWIER_32BIT SWIER_BIT;
  };
  union {
    __IO uint32_t PR;           /*!<EXTI Pending register,                        Address offset: 0x14 */
    EXTI_PR_32BIT PR_BIT;
  };
} EXTI_TypeDef;


/**
  * @brief Analog to Digital Converter(include ADC  0x4001 2400 - 0x4001 27FF)
  */
typedef struct {
  __IO uint32_t ADRDY             :  1;
  ...
  __IO uint32_t RES1              :  2;
  __IO uint32_t AWD               :  1;
  __IO uint32_t RES2              : 24;
} ADC_ISR_32BIT;

typedef struct {
  __IO uint32_t ADRDYIE           :  1;
  __IO uint32_t EOSMPIE           :  1;
  __IO uint32_t EOCIE             :  1;
  __IO uint32_t EOSEQIE           :  1;
...
typedef struct {
  __IO uint32_t CHSEL             : 19;
  __IO uint32_t RES1              : 13;
} ADC_CHSELR_32BIT;
...
typedef struct {
  __IO uint32_t RES1              : 22;
  __IO uint32_t VERFEN            :  1;
  __IO uint32_t TSEN              :  1;
  __IO uint32_t VBATEN            :  1;
  __IO uint32_t RES2              :  7;
} ADC_CCR_32BIT;
...
typedef struct {
  union {
    ...
    ADC_ISR_32BIT ISR_BIT;
  };
  union {
    __IO uint32_t IER;             /*!< ADC interrupt enable register,                 Address offset: 0x04 */
    ADC_IER_32BIT IER_BIT;
  };
  union {
  ...
  union {
    ...
    ADC_CFGR1_32BIT CFGR1_BIT;
  };
  union {
    __IO uint32_t CFGR2;           /*!< ADC configuration register 2,                  Address offset: 0x10 */
    ADC_CFGR2_32BIT CFGR2_BIT;
  };
  union {
    __IO uint32_t SMPR;            /*!< ADC sampling time register,                    Address offset: 0x14 */
    ADC_SMPR_32BIT SMPR_BIT;
  };
  ...
  union {
    ...
    ADC_CHSELR_32BIT CHSELR_BIT;
  };
         uint32_t RESERVED3[5];    /*!< Reserved,                                      Address offset: 0x2C-0x3C */
  union {
    __IO uint32_t DR;              /*!< ADC group regular data register,               Address offset: 0x40 */
    ADC_DR_32BIT DR_BIT;
  };
         uint32_t RESERVED4[177];  /*!< Reserved,                                      Address offset: 0x44-0x304 */
  union {
    __IO uint32_t CCR;             /*!< ADC common configuration register,             Address offset: 0x308 */
    ADC_CCR_32BIT CCR_BIT;
  };
} ADC_TypeDef;
...
/**
  * @brief Serial Peripheral Interface(include SPI/I2S  0x4001 3000 - 0x4001 33FF)
  */
typedef struct {
...
typedef struct {
  __IO uint32_t RXDMAE            :  1;
  __IO uint32_t TXDMAE            :  1;
  __IO uint32_t SSOE              :  1;
  __IO uint32_t NSSP              :  1;
  __IO uint32_t FRF               :  1;
  __IO uint32_t ERRIE             :  1;
  __IO uint32_t RXNEIE            :  1;
  __IO uint32_t TXEIE             :  1;
  __IO uint32_t DS                :  4;
  __IO uint32_t FRXTH             :  1;
  __IO uint32_t LDMA_RX           :  1;
  __IO uint32_t LDMA_TX           :  1;
  __IO uint32_t RES1              : 17;
} SPI_CR2_32BIT;
...
typedef struct {
  ...
  __IO uint32_t BSY               :  1;
  __IO uint32_t FRE               :  1;
  __IO uint32_t FRLVL             :  2;
  __IO uint32_t FTLVL             :  2;
  __IO uint32_t RES1              : 19;
} SPI_SR_32BIT;
...
typedef struct {
  __IO uint32_t CRCPOLY           : 16;
  __IO uint32_t RES1              : 16;
} SPI_CRCPR_32BIT;

typedef struct {
  __IO uint32_t CRC               : 16;
  __IO uint32_t RES1              : 16;
} SPI_CRCR_32BIT;
...
typedef struct {
  union {
    ...
    SPI_CR1_32BIT CR1_BIT;
  };
  union {
    __IO uint32_t CR2;        /*!< SPI Control register 2,                             Address offset: 0x04 */
    SPI_CR2_32BIT CR2_BIT;
  };
  union {
  ...
  union {
    ...
    SPI_CRCPR_32BIT CRCPR_BIT;
  };
  union {
    __IO uint32_t RXCRCR;     /*!< SPI Rx CRC register (not used in I2S mode),         Address offset: 0x14 */
    SPI_CRCR_32BIT RXCRCR_BIT;
  };
  union {
    __IO uint32_t TXCRCR;     /*!< SPI Tx CRC register (not used in I2S mode),         Address offset: 0x18 */
    SPI_CRCR_32BIT TXCRCR_BIT;
  };
  union {
    __IO uint32_t I2SCFGR;    /*!< SPI_I2S configuration register,                     Address offset: 0x1C */
    SPI_I2SCFGR_32BIT I2SCFGR_BIT;
  };
  union {
    __IO uint32_t I2SPR;      /*!< SPI_I2S prescaler register,                         Address offset: 0x20 */
    SPI_I2SPR_32BIT I2SPR_BIT;
  };
} SPI_TypeDef;


/**
  * @brief Universal Synchronous Asynchronous Receiver Transmitter(include USART  0x4001 3800 - 0x4001 3BFF)
  */
typedef struct {
  __IO uint32_t UE                :  1;
  __IO uint32_t UESM              :  1;
  __IO uint32_t RE                :  1;
  __IO uint32_t TE                :  1;
...
typedef struct {
  ...
  __IO uint32_t DATAINV           :  1;
  __IO uint32_t MSBFIRST          :  1;
  __IO uint32_t ABREN             :  1;
  __IO uint32_t ABRMOD            :  2;
  __IO uint32_t RTOEN             :  1;
  __IO uint32_t ADD               :  8;
} USART_CR2_32BIT;
...
typedef struct {
  ...
  __IO uint32_t IRLP              :  1;
  __IO uint32_t HDSEL             :  1;
  __IO uint32_t NACK              :  1;
  __IO uint32_t SCEN              :  1;
  __IO uint32_t DMAR              :  1;
  __IO uint32_t DMAT              :  1;
  __IO uint32_t RTSE              :  1;
  __IO uint32_t CTSE              :  1;
  __IO uint32_t CTSIE             :  1;
  __IO uint32_t ONEBIT            :  1;
  __IO uint32_t OVRDIS            :  1;
  __IO uint32_t DDRE              :  1;
  __IO uint32_t DEM               :  1;
  __IO uint32_t DEP               :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t SCARCNT           :  3;
  __IO uint32_t WUS               :  1;
  __IO uint32_t WUFIE             :  1;
  __IO uint32_t RES2              :  9;
} USART_CR3_32BIT;

typedef struct {
  __IO uint32_t BRR_DEC           :  4;
  __IO uint32_t BRR_INT           : 12;
  __IO uint32_t RES1              : 16;
} USART_BRR_32BIT;
...
typedef struct {
  __IO uint32_t RTO               : 24;
  __IO uint32_t BLEN              :  8;
} USART_RTOR_32BIT;

typedef struct {
  __IO uint32_t ABRRQ             :  1;
  __IO uint32_t SBKRQ             :  1;
  __IO uint32_t MMRQ              :  1;
  __IO uint32_t RXFRQ             :  1;
  __IO uint32_t TXFRQ             :  1;
  __IO uint32_t RES1              : 27;
} USART_RQR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t TC                :  1;
  __IO uint32_t TXE               :  1;
  __IO uint32_t LBDF              :  1;
  __IO uint32_t CTSIF             :  1;
  __IO uint32_t CTS               :  1;
  __IO uint32_t RTOF              :  1;
  __IO uint32_t EOBF              :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t ANRE              :  1;
  __IO uint32_t ABRF              :  1;
  __IO uint32_t BUSY              :  1;
  __IO uint32_t CMF               :  1;
  __IO uint32_t SBKF              :  1;
  __IO uint32_t RWU               :  1;
  __IO uint32_t WUF               :  1;
  __IO uint32_t TEACK             :  1;
  __IO uint32_t REACK             :  1;
  __IO uint32_t RES2              :  9;
} USART_ISR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t NCF               :  1;
  __IO uint32_t ORECF             :  1;
  __IO uint32_t IDLECF            :  1;
  __IO uint32_t RES1              :  1;
  __IO uint32_t TCCF              :  1;
  __IO uint32_t RES2              :  1;
  __IO uint32_t LBDCF             :  1;
  __IO uint32_t CTSCF             :  1;
  __IO uint32_t RES3              :  1;
  __IO uint32_t RTOCF             :  1;
  __IO uint32_t EOBCF             :  1;
  __IO uint32_t RES4              :  4;
  __IO uint32_t CMCF              :  1;
  __IO uint32_t RES5              :  2;
  __IO uint32_t WUCF              :  1;
  __IO uint32_t RES6              : 11;
} USART_ICR_32BIT;
...
typedef struct {
  union {
    ...
    USART_CR1_32BIT CR1_BIT;
  };
  union {
    __IO uint32_t CR2;    /*!< USART Control register 2,                 Address offset: 0x04 */
    USART_CR2_32BIT CR2_BIT;
  };
  union {
    __IO uint32_t CR3;    /*!< USART Control register 3,                 Address offset: 0x08 */
    USART_CR3_32BIT CR3_BIT;
  };
  union {
    __IO uint32_t BRR;    /*!< USART Baud rate register,                 Address offset: 0x0C */
    USART_BRR_32BIT BRR_BIT;
  };
  union {
    __IO uint32_t GTPR;   /*!< USART Guard time and prescaler register,  Address offset: 0x10 */
    USART_GTPR_32BIT GTPR_BIT;
  };
  union {
    __IO uint32_t RTOR;   /*!< USART Receiver Time Out register,         Address offset: 0x14 */
    USART_RTOR_32BIT RTOR_BIT;
  };
  union {
    __IO uint32_t RQR;    /*!< USART Request register,                   Address offset: 0x18 */
    USART_RQR_32BIT RQR_BIT;
  };
  union {
    __IO uint32_t ISR;    /*!< USART Interrupt and status register,      Address offset: 0x1C */
    USART_ISR_32BIT ISR_BIT;
  };
  union {
    __IO uint32_t ICR;    /*!< USART Interrupt flag Clear register,      Address offset: 0x20 */
    USART_ICR_32BIT ICR_BIT;
  };
  union {
    __IO uint32_t RDR;    /*!< USART Receive Data register,              Address offset: 0x24 */
    USART_DR_32BIT RDR_BIT;
  };
  union {
    __IO uint16_t TDR;    /*!< USART Transmit Data register,             Address offset: 0x28 */
    USART_DR_32BIT TDR_BIT;
  };
} USART_TypeDef;


/**
  * @brief Operational Amplifier and Voltage Comparator(include CMP/OPAMP  0x4001 3C00 - 0x4001 3FFF)
  */
typedef struct {
  __IO uint32_t EN                :  1;
  __IO uint32_t HYST              :  2;
  __IO uint32_t PSEL              :  3;
  __IO uint32_t NSEL              :  1;
  __IO uint32_t RVSEL             :  3;
  __IO uint32_t RES1              :  1;
  __IO uint32_t OFLT              :  3;
  __IO uint32_t RES2              :  1;
  __IO uint32_t POL               :  1;
  __IO uint32_t OUTSEL            :  3;
...
typedef struct {
  __IO uint32_t CPVREFEN          :  1;
  __IO uint32_t CP1VOLT           :  1;
  __IO uint32_t CP2VOLT           :  1;
  __IO uint32_t RES1              : 29;
} CMP_ANA_32BIT;

typedef struct {
  __IO uint32_t OPAMP1EN          :  1;
  __IO uint32_t OPAMP1NSEL        :  2;
  __IO uint32_t RES1              :  1;
  __IO uint32_t OPAMP1GAIN        :  2;
  __IO uint32_t RES2              :  1;
  __IO uint32_t OPAMP1OUTEN       :  1;
  __IO uint32_t OPAMP2EN          :  1;
  __IO uint32_t OPAMP2NSEL        :  2;
  __IO uint32_t RES3              :  1;
  __IO uint32_t OPAMP2GAIN        :  2;
  __IO uint32_t RES4              :  1;
  __IO uint32_t OPAMP2OUTEN       :  1;
  __IO uint32_t OPAMP3EN           :  1;
  __IO uint32_t OPAMP3NSEL        :  2;
  __IO uint32_t RES5              :  1;
  __IO uint32_t OPAMP3GAIN        :  2;
  __IO uint32_t RES6              :  1;
  __IO uint32_t OPAMP3OUTEN       :  1;
  __IO uint32_t RES7              :  7;
  __IO uint32_t OPAMPLCK          :  1;
} OP_CR_32BIT;

typedef struct {
  __IO uint32_t CALDATN           :  6;
  __IO uint32_t RES1              :  2;
  __IO uint32_t CALDATP           :  6;
  __IO uint32_t RES2              : 16;
...
typedef struct {
  union {
    __IO uint32_t CP1CR;       /*!< Comparator 1 Control register,                 Address offset: 0x00 */
    CMP_CR_32BIT CP1CR_BIT;
  };
  union {
    __IO uint32_t CP2CR;       /*!< Comparator 2 Control register,                 Address offset: 0x04 */
    CMP_CR_32BIT CP2CR_BIT;
  };
  union {
    __IO uint32_t CPANA;       /*!< Comparator analog register,                    Address offset: 0x08 */
    CMP_ANA_32BIT CPANA_BIT;
  };
  union {
    __IO uint32_t CP1CAL;      /*!< Comparator 1 calibration register,             Address offset: 0x0C */
    CMP_OP_CAL_32BIT CP1CAL_BIT;
  };
  union {
    __IO uint32_t CP2CAL;      /*!< Comparator 2 calibration register,             Address offset: 0x10 */
    CMP_OP_CAL_32BIT CP2CAL_BIT;
  };
  union {
    __IO uint32_t OPCR;        /*!< Operational Amplifier Control register,        Address offset: 0x14 */
    OP_CR_32BIT OPCR_BIT;
  };
  union {
    __IO uint32_t OP1CAL;      /*!< Operational Amplifier 1 calibration register,  Address offset: 0x18 */
    CMP_OP_CAL_32BIT OP1CAL_BIT;
  };
  union {
    __IO uint32_t OP2CAL;      /*!< Operational Amplifier 2 calibration register,  Address offset: 0x1C */
    CMP_OP_CAL_32BIT OP2CAL_BIT;
  };
  union {
    __IO uint32_t OP3CAL;      /*!< Operational Amplifier 3 calibration register,  Address offset: 0x20 */
    CMP_OP_CAL_32BIT OP3CAL_BIT;
  };
}CMP_OP_TypeDef;


/**
  * @brief Debug MCU(include DBGMCU  0x4001 5800 - 0x4001 5BFF)
  */
typedef struct {
  __IO uint32_t RES1                :  1;
  __IO uint32_t STOP                :  1;
  __IO uint32_t STANDBY             :  1;
  __IO uint32_t RES2                : 29;
} DBGMCU_CR_32BIT;

typedef struct {
  __IO uint32_t TIM2_STOP           :  1;
  __IO uint32_t TIM3_STOP           :  1;
  __IO uint32_t RES1                :  6;
  __IO uint32_t TIM14_STOP          :  1;
  __IO uint32_t RES2                :  1;
  __IO uint32_t RTC_STOP            :  1;
  __IO uint32_t WWDG_STOP           :  1;
  __IO uint32_t IWDG_STOP           :  1;
  __IO uint32_t RES3                :  8;
  __IO uint32_t I2C1_SMBUS_TIMEOUT  :  1;
  __IO uint32_t RES4                : 10;
} DBGMCU_APB1FZ_32BIT;

typedef struct {
  __IO uint32_t RES1                : 11;
  __IO uint32_t TIM1_STOP           :  1;
  __IO uint32_t RES2                :  5;
  __IO uint32_t TIM16_STOP          :  1;
  __IO uint32_t TIM17_STOP          :  1;
  __IO uint32_t RES3                : 13;
} DBGMCU_APB2FZ_32BIT;
...
typedef struct {
  union {
    ...
    DMA_CHN_CCR_32BIT CCR_BIT;
  };
  union {
    __IO uint32_t CNDTR;        /*!< DMA channel x number of data register       */
    DMA_CHN_CNDTR_32BIT CNDTR_BIT;
  };
...
typedef struct {
  union {
    ...
    DMA_SR_32BIT ISR_BIT;
  };
  union {
    __IO uint32_t IFCR;            /*!< DMA interrupt flag clear register,           Address offset: 0x04 */
    DMA_SR_32BIT IFCR_BIT;
  };
    DMA_Channel_TypeDef DMA_CHN1;  /*!< DMA channel 1 all register,                  Address offset: 0x08 */
    DMA_Channel_TypeDef DMA_CHN2;  /*!< DMA channel 2 all register,                  Address offset: 0x1C */
    DMA_Channel_TypeDef DMA_CHN3;  /*!< DMA channel 3 all register,                  Address offset: 0x30 */
    DMA_Channel_TypeDef DMA_CHN4;  /*!< DMA channel 4 all register,                  Address offset: 0x44 */
    DMA_Channel_TypeDef DMA_CHN5;  /*!< DMA channel 5 all register,                  Address offset: 0x58 */
} DMA_TypeDef;


/**
  * @brief Reset and Clock Control(include RCC  0x4002 1000 - 0x4002 13FF)
  */
typedef struct {
...
typedef struct {
  ...
  __IO uint32_t TIM16RST            :  1;
  __IO uint32_t TIM17RST            :  1;
  __IO uint32_t RES5                :  3;
  __IO uint32_t DBGMCURST           :  1;
  __IO uint32_t RES6                :  9;
} RCC_APB2RSTR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t RES2                :  1;
  __IO uint32_t FLITEN              :  1;
  __IO uint32_t RES3                :  1;
  __IO uint32_t CRCEN               :  1;
  __IO uint32_t RES4                : 10;
  __IO uint32_t IOPAEN              :  1;
  __IO uint32_t IOPBEN              :  1;
  __IO uint32_t IOPCEN              :  1;
  __IO uint32_t RES5                :  2;
  __IO uint32_t IOPFEN              :  1;
  __IO uint32_t RES6                :  9;
} RCC_AHBENR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t RES4                :  2;
  __IO uint32_t TIM16EN             :  1;
  __IO uint32_t TIM17EN             :  1;
  __IO uint32_t RES5                :  3;
  __IO uint32_t DBGMCUEN            :  1;
  __IO uint32_t RES6                :  9;
} RCC_APB2ENR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t RES1                : 21;
  __IO uint32_t V15PWRRSTF          :  1;
  __IO uint32_t RMVF                :  1;
  __IO uint32_t OBLRSTF             :  1;
...
typedef struct {
  __IO uint32_t RES1                : 17;
  __IO uint32_t IOPARST             :  1;
  __IO uint32_t IOPBRST             :  1;
  __IO uint32_t IOPCRST             :  1;
  __IO uint32_t RES2                :  2;
  __IO uint32_t IOPFRST             :  1;
  __IO uint32_t RES3                :  9;
} RCC_AHBRSTR_32BIT;

typedef struct {
  __IO uint32_t PREDIV              :  4;
  __IO uint32_t RES1                : 28;
} RCC_CFGR2_32BIT;

typedef struct {
  __IO uint32_t USART1SW            :  2;
  __IO uint32_t RES1                :  2;
  __IO uint32_t I2C1SW              :  1;
  __IO uint32_t RES2                : 27;
} RCC_CFGR3_32BIT;
...
typedef struct {
  ...
  union {
    ...
    RCC_CFGR_32BIT CFGR_BIT;
  };
  union {
    __IO uint32_t CIR;        /*!< RCC clock interrupt register,                                Address offset: 0x08 */
    RCC_CIR_32BIT CIR_BIT;
  };
  union {
    __IO uint32_t APB2RSTR;   /*!< RCC APB2 peripheral reset register,                          Address offset: 0x0C */
    RCC_APB2RSTR_32BIT APB2RSTR_BIT;
  };
  union {
    __IO uint32_t APB1RSTR;   /*!< RCC APB1 peripheral reset register,                          Address offset: 0x10 */
    RCC_APB1RSTR_32BIT APB1RSTR_BIT;
  };
  union {
    __IO uint32_t AHBENR;     /*!< RCC AHB peripheral clock register,                           Address offset: 0x14 */
    RCC_AHBENR_32BIT AHBENR_BIT;
  };
  union {
    __IO uint32_t APB2ENR;    /*!< RCC APB2 peripheral clock enable register,                   Address offset: 0x18 */
    RCC_APB2ENR_32BIT APB2ENR_BIT;
  };
  union {
    __IO uint32_t APB1ENR;    /*!< RCC APB1 peripheral clock enable register,                   Address offset: 0x1C */
    RCC_APB1ENR_32BIT APB1ENR_BIT;
  };
  union {
    __IO uint32_t BDCR;       /*!< RCC Backup domain control register,                          Address offset: 0x20 */
    RCC_BDCR_32BIT BDCR_BIT;
  };
  union {
    __IO uint32_t CSR;        /*!< RCC clock control & status register,                         Address offset: 0x24 */
    RCC_CSR_32BIT CSR_BIT;
  };
  union {
    __IO uint32_t AHBRSTR;    /*!< RCC AHB peripheral reset register,                           Address offset: 0x28 */
    RCC_AHBRSTR_32BIT AHBRSTR_BIT;
  };
  union {
    __IO uint32_t CFGR2;      /*!< RCC clock configuration register 2,                          Address offset: 0x2C */
    RCC_CFGR2_32BIT CFGR2_BIT;
  };
  union {
    __IO uint32_t CFGR3;      /*!< RCC clock configuration register 3,                          Address offset: 0x30 */
    RCC_CFGR3_32BIT CFGR3_BIT;
  };
} RCC_TypeDef;


/**
  * @brief FLASH Registers(include FLASH  0x4002 2000 - 0x4002 23FF)
  */
typedef struct {
  __IO uint32_t LATENCY             :  3;
  __IO uint32_t RES1                :  1;
  __IO uint32_t PRFTBE              :  1;
  __IO uint32_t PRFTBS              :  1;
  __IO uint32_t RES2                : 26;
} FLASH_ACR_32BIT;
...
typedef struct {
  __IO uint32_t BSY                 :  1;
  __IO uint32_t RES1                :  1;
  __IO uint32_t PGERR               :  1;
  __IO uint32_t RES2                :  1;
  __IO uint32_t WRPRTERR            :  1;
  __IO uint32_t EOP                 :  1;
  __IO uint32_t RES3                : 26;
} FLASH_SR_32BIT;
...
typedef struct {
  ...
  __IO uint32_t MER                 :  1;
  __IO uint32_t RES1                :  1;
  __IO uint32_t OPTPG               :  1;
  __IO uint32_t OPTER               :  1;
  __IO uint32_t STRT                :  1;
  __IO uint32_t LOCK                :  1;
  __IO uint32_t RES2                :  1;
  __IO uint32_t OPTWRE              :  1;
  __IO uint32_t ERRIE               :  1;
  __IO uint32_t RES3                :  1;
  __IO uint32_t EOPIE               :  1;
  __IO uint32_t OBL_LAUNCH          :  1;
  __IO uint32_t RES4                : 18;
} FLASH_CR_32BIT;

typedef struct {
  __IO uint32_t OPTERR              :  1;
  __IO uint32_t RDPRT               :  2;
  __IO uint32_t RES1                :  5;
  __IO uint32_t WDG_SW              :  1;
  __IO uint32_t nRST_STOP           :  1;
  __IO uint32_t nRST_STDBY          :  1;
  __IO uint32_t RES2                :  1;
  __IO uint32_t nBOOT1              :  1;
  __IO uint32_t VDDA_MONITOR        :  1;
  __IO uint32_t RAM_PARITY_CHECK    :  1;
  __IO uint32_t RES3                :  1;
...
/**
  * @brief CRC calculation unit(include CRC  0x4002 3000 - 0x4002 33FF)
  */
typedef struct {
  __IO uint32_t IDR                 :  8;
  __IO uint32_t RES1                : 24;
...
/**
  * @brief General Purpose I/O(include GPIOA  0x4800 0000 - 0x4800 03FF
  *                                    GPIOB  0x4800 0400 - 0x4800 07FF
  *                                    GPIOC  0x4800 0800 - 0x4800 0BFF
  *                                    GPIOF  0x4800 1400 - 0x4800 17FF)
  */
typedef struct {
  __IO uint32_t PIN0                :  2;
  __IO uint32_t PIN1                :  2;
  __IO uint32_t PIN2                :  2;
  __IO uint32_t PIN3                :  2;
  __IO uint32_t PIN4                :  2;
  __IO uint32_t PIN5                :  2;
  __IO uint32_t PIN6                :  2;
  __IO uint32_t PIN7                :  2;
  __IO uint32_t PIN8                :  2;
  __IO uint32_t PIN9                :  2;
  __IO uint32_t PIN10               :  2;
  __IO uint32_t PIN11               :  2;
  __IO uint32_t PIN12               :  2;
  __IO uint32_t PIN13               :  2;
  __IO uint32_t PIN14               :  2;
  __IO uint32_t PIN15               :  2;
} GPIO_NBIT_32BIT;
...
typedef struct {
  __IO uint32_t PIN0_SET           :  1;
  __IO uint32_t PIN1_SET           :  1;
  __IO uint32_t PIN2_SET           :  1;
  __IO uint32_t PIN3_SET           :  1;
  __IO uint32_t PIN4_SET           :  1;
  __IO uint32_t PIN5_SET           :  1;
  __IO uint32_t PIN6_SET           :  1;
  __IO uint32_t PIN7_SET           :  1;
  __IO uint32_t PIN8_SET           :  1;
  __IO uint32_t PIN9_SET           :  1;
  __IO uint32_t PIN10_SET          :  1;
  __IO uint32_t PIN11_SET          :  1;
  __IO uint32_t PIN12_SET          :  1;
  __IO uint32_t PIN13_SET          :  1;
  __IO uint32_t PIN14_SET          :  1;
  __IO uint32_t PIN15_SET          :  1;
  __IO uint32_t PIN0_RESET         :  1;
  __IO uint32_t PIN1_RESET         :  1;
  __IO uint32_t PIN2_RESET         :  1;
  __IO uint32_t PIN3_RESET         :  1;
  __IO uint32_t PIN4_RESET         :  1;
  __IO uint32_t PIN5_RESET         :  1;
  __IO uint32_t PIN6_RESET         :  1;
  __IO uint32_t PIN7_RESET         :  1;
  __IO uint32_t PIN8_RESET         :  1;
  __IO uint32_t PIN9_RESET         :  1;
  __IO uint32_t PIN10_RESET        :  1;
  __IO uint32_t PIN11_RESET        :  1;
  __IO uint32_t PIN12_RESET        :  1;
  __IO uint32_t PIN13_RESET        :  1;
  __IO uint32_t PIN14_RESET        :  1;
  __IO uint32_t PIN15_RESET        :  1;
} GPIO_SR_32BIT;
...
typedef struct {
  __IO uint32_t PIN0                :  4;
  __IO uint32_t PIN1                :  4;
  __IO uint32_t PIN2                :  4;
  __IO uint32_t PIN3                :  4;
  __IO uint32_t PIN4                :  4;
  __IO uint32_t PIN5                :  4;
  __IO uint32_t PIN6                :  4;
  __IO uint32_t PIN7                :  4;
} GPIO_AFRL_32BIT;

typedef struct {
  __IO uint32_t PIN8                :  4;
  __IO uint32_t PIN9                :  4;
  __IO uint32_t PIN10               :  4;
  __IO uint32_t PIN11               :  4;
  __IO uint32_t PIN12               :  4;
  __IO uint32_t PIN13               :  4;
  __IO uint32_t PIN14               :  4;
  __IO uint32_t PIN15               :  4;
} GPIO_AFRH_32BIT;
...
typedef struct {
  union {
    ...
    GPIO_NBIT_32BIT MODER_BIT;
  };
  union {
    __IO uint32_t OTYPER;       /*!< GPIO port output type register,              Address offset: 0x04 */
    GPIO_BIT_32BIT OTYPER_BIT;
  };
  union {
    __IO uint32_t OSPEEDR;      /*!< GPIO port output speed register,             Address offset: 0x08 */
    GPIO_NBIT_32BIT OSPEEDR_BIT;
  };
  union {
    __IO uint32_t PUPDR;        /*!< GPIO port pull-up/pull-down register,        Address offset: 0x0C */
    GPIO_NBIT_32BIT PUPDR_BIT;
  };
  union {
    __IO uint32_t IDR;          /*!< GPIO port input data register,               Address offset: 0x10 */
    GPIO_BIT_32BIT IDR_BIT;
  };
  union {
    __IO uint32_t ODR;          /*!< GPIO port output data register,              Address offset: 0x14 */
    GPIO_BIT_32BIT ODR_BIT;
  };
  union {
    __IO uint32_t BSRR;         /*!< GPIO port bit set/reset register,            Address offset: 0x1A */
    GPIO_SR_32BIT BSRR_BIT;
  };
  union {
    __IO uint32_t LCKR;         /*!< GPIO port configuration lock register,       Address offset: 0x1C */
    GPIO_LCK_32BIT LCKR_BIT;
  };
  union {
    __IO uint32_t AFRL;         /*!< GPIO alternate function low register,        Address offset: 0x20 */
    GPIO_AFRL_32BIT AFRL_BIT;
  };
  union {
    __IO uint32_t AFRH;         /*!< GPIO alternate function high register,       Address offset: 0x24 */
    GPIO_AFRH_32BIT AFRH_BIT;
  };
  union {
    __IO uint32_t BRR;          /*!< GPIO bit reset register,                     Address offset: 0x28 */
    GPIO_BIT_32BIT BRR_BIT;
  };
} GPIO_TypeDef;


/**
  * @brief Option Bytes Registers(include OPTION  0x1FFF F800 - 0x1FFF FBFF)
  */
typedef struct {
...
#define ADC_BASE              (APBPERIPH_BASE + 0x00012400UL + 0x308UL)
...
#define CMP_OP_BASE           (APBPERIPH_BASE + 0x00013C00UL)
...
#define CMP_OP              ((CMP_OP_TypeDef *) CMP_OP_BASE)
...
#define ADC_ISR_AWD               ADC_ISR_AWD_Msk                               /*!< ADC analog watchdog flag */
...
#define ADC_IER_AWDIE             ADC_IER_AWDIE_Msk                             /*!< ADC analog watchdog interrupt */
...
#define ADC_CFGR1_AWDSGL          ADC_CFGR1_AWDSGL_Msk                          /*!< ADC analog watchdog monitoring a single channel or all channels */

#define ADC_CFGR1_AWDEN_Pos       (23U)
#define ADC_CFGR1_AWDEN_Msk       (0x1UL << ADC_CFGR1_AWDEN_Pos)                /*!< 0x00800000 */
#define ADC_CFGR1_AWDEN           ADC_CFGR1_AWDEN_Msk                           /*!< ADC analog watchdog enable on scope ADC group regular */

#define ADC_CFGR1_AWDCH_Pos       (26U)
#define ADC_CFGR1_AWDCH_Msk       (0x1FUL << ADC_CFGR1_AWDCH_Pos)               /*!< 0x7C000000 */
#define ADC_CFGR1_AWDCH           ADC_CFGR1_AWDCH_Msk                           /*!< ADC analog watchdog monitored channel selection */
...
#define ADC_TR_LT                 ADC_TR_LT_Msk                                 /*!< ADC analog watchdog threshold low */
...
#define ADC_TR_HT                 ADC_TR_HT_Msk                                 /*!< ADC Analog watchdog threshold high */
...
#define ADC_CHSELR_CHSEL_Msk      (0x3FFFFFUL << ADC_CHSELR_CHSEL_Pos)          /*!< 0x003FFFFF */
...
/******************************************************************************/
/*                                                                            */
/*                       Voltage Comparator  (COMP)                           */
/*                                                                            */
/******************************************************************************/
/******************  Bit definition for CMP_CPxCR register  *******************/
#define CMP_CPxCR_CPxEN_Pos        (0U)
#define CMP_CPxCR_CPxEN_Msk        (0x1UL << CMP_CPxCR_CPxEN_Pos)               /*!< 0x00000001 */
#define CMP_CPxCR_CPxEN            CMP_CPxCR_CPxEN_Msk

#define CMP_CPxCR_CPxHYST_Pos      (1U)
#define CMP_CPxCR_CPxHYST_Msk      (0x3UL << CMP_CPxCR_CPxHYST_Pos)             /*!< 0x00000006 */
#define CMP_CPxCR_CPxHYST          CMP_CPxCR_CPxHYST_Msk
#define CMP_CPxCR_CPxHYST_0        (0x01UL << CMP_CPxCR_CPxHYST_Pos)
#define CMP_CPxCR_CPxHYST_1        (0x02UL << CMP_CPxCR_CPxHYST_Pos)

#define CMP_CPxCR_CPxPSEL_Pos      (3U)
#define CMP_CPxCR_CPxPSEL_Msk      (0x7UL << CMP_CPxCR_CPxPSEL_Pos)             /*!< 0x00000038 */
#define CMP_CPxCR_CPxPSEL          CMP_CPxCR_CPxPSEL_Msk
#define CMP_CPxCR_CPxPSEL_0        (0x01UL << CMP_CPxCR_CPxPSEL_Pos)
#define CMP_CPxCR_CPxPSEL_1        (0x02UL << CMP_CPxCR_CPxPSEL_Pos)
#define CMP_CPxCR_CPxPSEL_2        (0x04UL << CMP_CPxCR_CPxPSEL_Pos)

#define CMP_CPxCR_CPxNSEL_Pos      (6U)
#define CMP_CPxCR_CPxNSEL_Msk      (0x1UL << CMP_CPxCR_CPxNSEL_Pos)             /*!< 0x00000040 */
#define CMP_CPxCR_CPxNSEL          CMP_CPxCR_CPxNSEL_Msk

#define CMP_CPxCR_CPxRVSEL_Pos     (7U)
#define CMP_CPxCR_CPxRVSEL_Msk     (0x7UL << CMP_CPxCR_CPxRVSEL_Pos)            /*!< 0x00000380 */
#define CMP_CPxCR_CPxRVSEL         CMP_CPxCR_CPxRVSEL_Msk
#define CMP_CPxCR_CPxRVSEL_0       (0x01UL << CMP_CPxCR_CPxRVSEL_Pos)
#define CMP_CPxCR_CPxRVSEL_1       (0x02UL << CMP_CPxCR_CPxRVSEL_Pos)
#define CMP_CPxCR_CPxRVSEL_2       (0x04UL << CMP_CPxCR_CPxRVSEL_Pos)

#define CMP_CPxCR_CPxOFLT_Pos      (11U)
#define CMP_CPxCR_CPxOFLT_Msk      (0x7UL << CMP_CPxCR_CPxOFLT_Pos)             /*!< 0x00003800 */
#define CMP_CPxCR_CPxOFLT          CMP_CPxCR_CPxOFLT_Msk
#define CMP_CPxCR_CPxOFLT_0        (0x01UL << CMP_CPxCR_CPxOFLT_Pos)
#define CMP_CPxCR_CPxOFLT_1        (0x02UL << CMP_CPxCR_CPxOFLT_Pos)
#define CMP_CPxCR_CPxOFLT_2        (0x04UL << CMP_CPxCR_CPxOFLT_Pos)

#define CMP_CPxCR_CPxPOL_Pos       (15U)
#define CMP_CPxCR_CPxPOL_Msk       (0x1UL << CMP_CPxCR_CPxPOL_Pos)              /*!< 0x00008000 */
#define CMP_CPxCR_CPxPOL           CMP_CPxCR_CPxPOL_Msk

#define CMP_CPxCR_CPxOUTSEL_Pos    (16U)
#define CMP_CPxCR_CPxOUTSEL_Msk    (0x7UL << CMP_CPxCR_CPxOUTSEL_Pos)           /*!< 0x00070000 */
#define CMP_CPxCR_CPxOUTSEL        CMP_CPxCR_CPxOUTSEL_Msk
#define CMP_CPxCR_CPxOUTSEL_0      (0x01UL << CMP_CPxCR_CPxOUTSEL_Pos)
#define CMP_CPxCR_CPxOUTSEL_1      (0x02UL << CMP_CPxCR_CPxOUTSEL_Pos)
#define CMP_CPxCR_CPxOUTSEL_2      (0x04UL << CMP_CPxCR_CPxOUTSEL_Pos)

#define CMP_CPxCR_CPxOUT_Pos       (30U)
#define CMP_CPxCR_CPxOUT_Msk       (0x1UL << CMP_CPxCR_CPxOUT_Pos)              /*!< 0x40000000 */
#define CMP_CPxCR_CPxOUT           CMP_CPxCR_CPxOUT_Msk

#define CMP_CPxCR_CPxLCK_Pos       (31U)
#define CMP_CPxCR_CPxLCK_Msk       (0x1UL << CMP_CPxCR_CPxLCK_Pos)              /*!< 0x80000000 */
#define CMP_CPxCR_CPxLCK           CMP_CPxCR_CPxLCK_Msk
   
/******************  Bit definition for CMP_CPANA register  *******************/
#define CMP_CPANA_CPVREFEN_Pos     (0U)
#define CMP_CPANA_CPVREFEN_Msk     (0x1UL << CMP_CPANA_CPVREFEN_Pos)            /*!< 0x00000001 */
#define CMP_CPANA_CPVREFEN         CMP_CPANA_CPVREFEN_Msk

#define CMP_CPANA_CP1VOLT_Pos      (1U)
#define CMP_CPANA_CP1VOLT_Msk      (0x1UL << CMP_CPANA_CP1VOLT_Pos)             /*!< 0x00000002 */
#define CMP_CPANA_CP1VOLT          CMP_CPANA_CP1VOLT_Msk

#define CMP_CPANA_CP2VOLT_Pos      (2U)
#define CMP_CPANA_CP2VOLT_Msk      (0x1UL << CMP_CPANA_CP2VOLT_Pos)             /*!< 0x00000004 */
#define CMP_CPANA_CP2VOLT          CMP_CPANA_CP2VOLT_Msk

/******************  Bit definition for CMP_CPxCAL register  ******************/
#define CMP_CPxCAL_CPxCALDATN_Pos  (0U)
#define CMP_CPxCAL_CPxCALDATN_Msk  (0x3FUL << CMP_CPxCAL_CPxCALDATN_Pos)        /*!< 0x0000003F */
#define CMP_CPxCAL_CPxCALDATN      CMP_CPxCAL_CPxCALDATN_Msk
#define CMP_CPxCAL_CPxCALDATN_0    (0x01UL << CMP_CPxCAL_CPxCALDATN_Pos)
#define CMP_CPxCAL_CPxCALDATN_1    (0x02UL << CMP_CPxCAL_CPxCALDATN_Pos)
#define CMP_CPxCAL_CPxCALDATN_2    (0x04UL << CMP_CPxCAL_CPxCALDATN_Pos)
#define CMP_CPxCAL_CPxCALDATN_3    (0x08UL << CMP_CPxCAL_CPxCALDATN_Pos)
#define CMP_CPxCAL_CPxCALDATN_4    (0x10UL << CMP_CPxCAL_CPxCALDATN_Pos)
#define CMP_CPxCAL_CPxCALDATN_5    (0x20UL << CMP_CPxCAL_CPxCALDATN_Pos)

#define CMP_CPxCAL_CPxCALDATP_Pos  (8U)
#define CMP_CPxCAL_CPxCALDATP_Msk  (0x3FUL << CMP_CPxCAL_CPxCALDATP_Pos)        /*!< 0x00003F00 */
#define CMP_CPxCAL_CPxCALDATP      CMP_CPxCAL_CPxCALDATP_Msk
#define CMP_CPxCAL_CPxCALDATP_0    (0x01UL << CMP_CPxCAL_CPxCALDATP_Pos)
#define CMP_CPxCAL_CPxCALDATP_1    (0x02UL << CMP_CPxCAL_CPxCALDATP_Pos)
#define CMP_CPxCAL_CPxCALDATP_2    (0x04UL << CMP_CPxCAL_CPxCALDATP_Pos)
#define CMP_CPxCAL_CPxCALDATP_3    (0x08UL << CMP_CPxCAL_CPxCALDATP_Pos)
#define CMP_CPxCAL_CPxCALDATP_4    (0x10UL << CMP_CPxCAL_CPxCALDATP_Pos)
#define CMP_CPxCAL_CPxCALDATP_5    (0x20UL << CMP_CPxCAL_CPxCALDATP_Pos)

#define CMP_CPxCAL_CPxSYNC_Pos     (30U)
#define CMP_CPxCAL_CPxSYNC_Msk     (0x1UL << CMP_CPxCAL_CPxSYNC_Pos)            /*!< 0x40000000 */
#define CMP_CPxCAL_CPxSYNC         CMP_CPxCAL_CPxSYNC_Msk

#define CMP_CPxCAL_CPxCALEN_Pos    (31U)
#define CMP_CPxCAL_CPxCALEN_Msk    (0x1UL << CMP_CPxCAL_CPxCALEN_Pos)           /*!< 0x80000000 */
#define CMP_CPxCAL_CPxCALEN        CMP_CPxCAL_CPxCALEN_Msk
...
#define CRC_DR_DR_0              (0x00000001UL << CRC_DR_DR_Pos)                /*!< 0x00000001 */
#define CRC_DR_DR_1              (0x00000002UL << CRC_DR_DR_Pos)                /*!< 0x00000002 */
#define CRC_DR_DR_2              (0x00000004UL << CRC_DR_DR_Pos)                /*!< 0x00000004 */
#define CRC_DR_DR_3              (0x00000008UL << CRC_DR_DR_Pos)                /*!< 0x00000008 */
#define CRC_DR_DR_4              (0x00000010UL << CRC_DR_DR_Pos)                /*!< 0x00000010 */
#define CRC_DR_DR_5              (0x00000020UL << CRC_DR_DR_Pos)                /*!< 0x00000020 */
#define CRC_DR_DR_6              (0x00000040UL << CRC_DR_DR_Pos)                /*!< 0x00000040 */
#define CRC_DR_DR_7              (0x00000080UL << CRC_DR_DR_Pos)                /*!< 0x00000080 */
#define CRC_DR_DR_8              (0x00000100UL << CRC_DR_DR_Pos)                /*!< 0x00000100 */
#define CRC_DR_DR_9              (0x00000200UL << CRC_DR_DR_Pos)                /*!< 0x00000200 */
#define CRC_DR_DR_10             (0x00000400UL << CRC_DR_DR_Pos)                /*!< 0x00000400 */
#define CRC_DR_DR_11             (0x00000800UL << CRC_DR_DR_Pos)                /*!< 0x00000800 */
#define CRC_DR_DR_12             (0x00001000UL << CRC_DR_DR_Pos)                /*!< 0x00001000 */
#define CRC_DR_DR_13             (0x00002000UL << CRC_DR_DR_Pos)                /*!< 0x00002000 */
#define CRC_DR_DR_14             (0x00004000UL << CRC_DR_DR_Pos)                /*!< 0x00004000 */
#define CRC_DR_DR_15             (0x00008000UL << CRC_DR_DR_Pos)                /*!< 0x00008000 */
#define CRC_DR_DR_16             (0x00010000UL << CRC_DR_DR_Pos)                /*!< 0x00010000 */
#define CRC_DR_DR_17             (0x00020000UL << CRC_DR_DR_Pos)                /*!< 0x00020000 */
#define CRC_DR_DR_18             (0x00040000UL << CRC_DR_DR_Pos)                /*!< 0x00040000 */
#define CRC_DR_DR_19             (0x00080000UL << CRC_DR_DR_Pos)                /*!< 0x00080000 */
#define CRC_DR_DR_20             (0x00100000UL << CRC_DR_DR_Pos)                /*!< 0x00100000 */
#define CRC_DR_DR_21             (0x00200000UL << CRC_DR_DR_Pos)                /*!< 0x00200000 */
#define CRC_DR_DR_22             (0x00400000UL << CRC_DR_DR_Pos)                /*!< 0x00400000 */
#define CRC_DR_DR_23             (0x00800000UL << CRC_DR_DR_Pos)                /*!< 0x00800000 */
#define CRC_DR_DR_24             (0x01000000UL << CRC_DR_DR_Pos)                /*!< 0x01000000 */
#define CRC_DR_DR_25             (0x02000000UL << CRC_DR_DR_Pos)                /*!< 0x02000000 */
#define CRC_DR_DR_26             (0x04000000UL << CRC_DR_DR_Pos)                /*!< 0x04000000 */
#define CRC_DR_DR_27             (0x08000000UL << CRC_DR_DR_Pos)                /*!< 0x08000000 */
#define CRC_DR_DR_28             (0x10000000UL << CRC_DR_DR_Pos)                /*!< 0x10000000 */
#define CRC_DR_DR_29             (0x20000000UL << CRC_DR_DR_Pos)                /*!< 0x20000000 */
...
#define CRC_IDR_IDR              CRC_IDR_IDR_Msk                                /*!< Independent Data register bits */
#define CRC_IDR_IDR_0            (0x01UL << CRC_IDR_IDR_Pos)                    /*!< 0x00000001 */
#define CRC_IDR_IDR_1            (0x02UL << CRC_IDR_IDR_Pos)                    /*!< 0x00000002 */
#define CRC_IDR_IDR_2            (0x04UL << CRC_IDR_IDR_Pos)                    /*!< 0x00000004 */
#define CRC_IDR_IDR_3            (0x08UL << CRC_IDR_IDR_Pos)                    /*!< 0x00000008 */
...
#define CRC_INIT_INIT_0          (0x00000001UL << CRC_INIT_INIT_Pos)            /*!< 0x00000001 */
#define CRC_INIT_INIT_1          (0x00000002UL << CRC_INIT_INIT_Pos)            /*!< 0x00000002 */
#define CRC_INIT_INIT_2          (0x00000004UL << CRC_INIT_INIT_Pos)            /*!< 0x00000004 */
#define CRC_INIT_INIT_3          (0x00000008UL << CRC_INIT_INIT_Pos)            /*!< 0x00000008 */
#define CRC_INIT_INIT_4          (0x00000010UL << CRC_INIT_INIT_Pos)            /*!< 0x00000010 */
#define CRC_INIT_INIT_5          (0x00000020UL << CRC_INIT_INIT_Pos)            /*!< 0x00000020 */
#define CRC_INIT_INIT_6          (0x00000040UL << CRC_INIT_INIT_Pos)            /*!< 0x00000040 */
#define CRC_INIT_INIT_7          (0x00000080UL << CRC_INIT_INIT_Pos)            /*!< 0x00000080 */
#define CRC_INIT_INIT_8          (0x00000100UL << CRC_INIT_INIT_Pos)            /*!< 0x00000100 */
#define CRC_INIT_INIT_9          (0x00000200UL << CRC_INIT_INIT_Pos)            /*!< 0x00000200 */
#define CRC_INIT_INIT_10         (0x00000400UL << CRC_INIT_INIT_Pos)            /*!< 0x00000400 */
#define CRC_INIT_INIT_11         (0x00000800UL << CRC_INIT_INIT_Pos)            /*!< 0x00000800 */
#define CRC_INIT_INIT_12         (0x00001000UL << CRC_INIT_INIT_Pos)            /*!< 0x00001000 */
#define CRC_INIT_INIT_13         (0x00002000UL << CRC_INIT_INIT_Pos)            /*!< 0x00002000 */
#define CRC_INIT_INIT_14         (0x00004000UL << CRC_INIT_INIT_Pos)            /*!< 0x00004000 */
#define CRC_INIT_INIT_15         (0x00008000UL << CRC_INIT_INIT_Pos)            /*!< 0x00008000 */
#define CRC_INIT_INIT_16         (0x00010000UL << CRC_INIT_INIT_Pos)            /*!< 0x00010000 */
#define CRC_INIT_INIT_17         (0x00020000UL << CRC_INIT_INIT_Pos)            /*!< 0x00020000 */
#define CRC_INIT_INIT_18         (0x00040000UL << CRC_INIT_INIT_Pos)            /*!< 0x00040000 */
#define CRC_INIT_INIT_19         (0x00080000UL << CRC_INIT_INIT_Pos)            /*!< 0x00080000 */
#define CRC_INIT_INIT_20         (0x00100000UL << CRC_INIT_INIT_Pos)            /*!< 0x00100000 */
#define CRC_INIT_INIT_21         (0x00200000UL << CRC_INIT_INIT_Pos)            /*!< 0x00200000 */
#define CRC_INIT_INIT_22         (0x00400000UL << CRC_INIT_INIT_Pos)            /*!< 0x00400000 */
#define CRC_INIT_INIT_23         (0x00800000UL << CRC_INIT_INIT_Pos)            /*!< 0x00800000 */
#define CRC_INIT_INIT_24         (0x01000000UL << CRC_INIT_INIT_Pos)            /*!< 0x01000000 */
#define CRC_INIT_INIT_25         (0x02000000UL << CRC_INIT_INIT_Pos)            /*!< 0x02000000 */
#define CRC_INIT_INIT_26         (0x04000000UL << CRC_INIT_INIT_Pos)            /*!< 0x04000000 */
#define CRC_INIT_INIT_27         (0x08000000UL << CRC_INIT_INIT_Pos)            /*!< 0x08000000 */
#define CRC_INIT_INIT_28         (0x10000000UL << CRC_INIT_INIT_Pos)            /*!< 0x10000000 */
#define CRC_INIT_INIT_29         (0x20000000UL << CRC_INIT_INIT_Pos)            /*!< 0x20000000 */
...
#define CRC_POL_POL              CRC_POL_POL_Msk                                /*!< CRC polynomial value bits */
#define CRC_POL_POL_0            (0x00000001UL << CRC_POL_POL_Pos)              /*!< 0x00000001 */
#define CRC_POL_POL_1            (0x00000002UL << CRC_POL_POL_Pos)              /*!< 0x00000002 */
#define CRC_POL_POL_2            (0x00000004UL << CRC_POL_POL_Pos)              /*!< 0x00000004 */
#define CRC_POL_POL_3            (0x00000008UL << CRC_POL_POL_Pos)              /*!< 0x00000008 */
#define CRC_POL_POL_4            (0x00000010UL << CRC_POL_POL_Pos)              /*!< 0x00000010 */
#define CRC_POL_POL_5            (0x00000020UL << CRC_POL_POL_Pos)              /*!< 0x00000020 */
#define CRC_POL_POL_6            (0x00000040UL << CRC_POL_POL_Pos)              /*!< 0x00000040 */
#define CRC_POL_POL_7            (0x00000080UL << CRC_POL_POL_Pos)              /*!< 0x00000080 */
#define CRC_POL_POL_8            (0x00000100UL << CRC_POL_POL_Pos)              /*!< 0x00000100 */
#define CRC_POL_POL_9            (0x00000200UL << CRC_POL_POL_Pos)              /*!< 0x00000200 */
#define CRC_POL_POL_10           (0x00000400UL << CRC_POL_POL_Pos)              /*!< 0x00000400 */
#define CRC_POL_POL_11           (0x00000800UL << CRC_POL_POL_Pos)              /*!< 0x00000800 */
#define CRC_POL_POL_12           (0x00001000UL << CRC_POL_POL_Pos)              /*!< 0x00001000 */
#define CRC_POL_POL_13           (0x00002000UL << CRC_POL_POL_Pos)              /*!< 0x00002000 */
#define CRC_POL_POL_14           (0x00004000UL << CRC_POL_POL_Pos)              /*!< 0x00004000 */
#define CRC_POL_POL_15           (0x00008000UL << CRC_POL_POL_Pos)              /*!< 0x00008000 */
#define CRC_POL_POL_16           (0x00010000UL << CRC_POL_POL_Pos)              /*!< 0x00010000 */
#define CRC_POL_POL_17           (0x00020000UL << CRC_POL_POL_Pos)              /*!< 0x00020000 */
#define CRC_POL_POL_18           (0x00040000UL << CRC_POL_POL_Pos)              /*!< 0x00040000 */
#define CRC_POL_POL_19           (0x00080000UL << CRC_POL_POL_Pos)              /*!< 0x00080000 */
#define CRC_POL_POL_20           (0x00100000UL << CRC_POL_POL_Pos)              /*!< 0x00100000 */
#define CRC_POL_POL_21           (0x00200000UL << CRC_POL_POL_Pos)              /*!< 0x00200000 */
#define CRC_POL_POL_22           (0x00400000UL << CRC_POL_POL_Pos)              /*!< 0x00400000 */
#define CRC_POL_POL_23           (0x00800000UL << CRC_POL_POL_Pos)              /*!< 0x00800000 */
#define CRC_POL_POL_24           (0x01000000UL << CRC_POL_POL_Pos)              /*!< 0x01000000 */
#define CRC_POL_POL_25           (0x02000000UL << CRC_POL_POL_Pos)              /*!< 0x02000000 */
#define CRC_POL_POL_26           (0x04000000UL << CRC_POL_POL_Pos)              /*!< 0x04000000 */
#define CRC_POL_POL_27           (0x08000000UL << CRC_POL_POL_Pos)              /*!< 0x08000000 */
#define CRC_POL_POL_28           (0x10000000UL << CRC_POL_POL_Pos)              /*!< 0x10000000 */
#define CRC_POL_POL_29           (0x20000000UL << CRC_POL_POL_Pos)              /*!< 0x20000000 */
#define CRC_POL_POL_30           (0x40000000UL << CRC_POL_POL_Pos)              /*!< 0x40000000 */
#define CRC_POL_POL_31           (0x80000000UL << CRC_POL_POL_Pos)              /*!< 0x80000000 */
...
#define EXTI_IMR_IM_Msk           (0x02EBFFFFUL << EXTI_IMR_IM_Pos)             /*!< 0x0AEBFFFF */
...
#define EXTI_EMR_EM_Msk           (0x0AEBFFFFUL << EXTI_EMR_EM_Pos)             /*!< 0x0AEBFFFF */
...
#define EXTI_RTSR_RT_Pos          (0U)
#define EXTI_RTSR_RT_Msk          (0x006BFFFFUL << EXTI_RTSR_RT_Pos)            /*!< 0x006BFFFF */
#define EXTI_RTSR_RT              EXTI_RTSR_RT_Msk                              /*!< Rising trigger event configuration All */
...
#define EXTI_FTSR_FT_Pos          (0U)
#define EXTI_FTSR_FT_Msk          (0x006BFFFFUL << EXTI_FTSR_FT_Pos)            /*!< 0x006BFFFF */
#define EXTI_FTSR_FT              EXTI_FTSR_FT_Msk                              /*!< Falling trigger event configuration All */
...
#define EXTI_SWIER_SWI_Pos        (0U)
#define EXTI_SWIER_SWI_Msk        (0x006BFFFFUL << EXTI_SWIER_SWI_Pos)          /*!< 0x006BFFFF */
#define EXTI_SWIER_SWI            EXTI_SWIER_SWI_Msk                            /*!< Software Interrupt All */
...
#define EXTI_PR_PIF_Pos           (0U)
#define EXTI_PR_PIF_Msk           (0x006BFFFFUL << EXTI_PR_PIF_Pos)             /*!< 0x006BFFFF */
#define EXTI_PR_PIF               EXTI_PR_PIF_Msk                               /*!< Pending All */
...
/*                                                                            */
/******************************************************************************/
/******************  Bit definition for OPAMP_OPCR register  ******************/
#define OPAMP_OPCR_OPAMP1EN_Pos     (0U)
#define OPAMP_OPCR_OPAMP1EN_Msk     (0x1UL << OPAMP_OPCR_OPAMP1EN_Pos)          /*!< 0x00000001 */
#define OPAMP_OPCR_OPAMP1EN         OPAMP_OPCR_OPAMP1EN_Msk

#define OPAMP_OPCR_OPAMP1NSEL_Pos   (1U)
#define OPAMP_OPCR_OPAMP1NSEL_Msk   (0x3UL << OPAMP_OPCR_OPAMP1NSEL_Pos)        /*!< 0x00000006 */
#define OPAMP_OPCR_OPAMP1NSEL       OPAMP_OPCR_OPAMP1NSEL_Msk
#define OPAMP_OPCR_OPAMP1NSEL_0     (0x1UL << OPAMP_OPCR_OPAMP1NSEL_Pos)
#define OPAMP_OPCR_OPAMP1NSEL_1     (0x2UL << OPAMP_OPCR_OPAMP1NSEL_Pos)

#define OPAMP_OPCR_OPAMP1GAIN_Pos   (4U)
#define OPAMP_OPCR_OPAMP1GAIN_Msk   (0x3UL << OPAMP_OPCR_OPAMP1GAIN_Pos)        /*!< 0x00000030 */
#define OPAMP_OPCR_OPAMP1GAIN       OPAMP_OPCR_OPAMP1GAIN_Msk
#define OPAMP_OPCR_OPAMP1GAIN_0     (0x1UL << OPAMP_OPCR_OPAMP1GAIN_Pos)
#define OPAMP_OPCR_OPAMP1GAIN_1     (0x2UL << OPAMP_OPCR_OPAMP1GAIN_Pos)

#define OPAMP_OPCR_OPAMP1OUTEN_Pos  (7U)
#define OPAMP_OPCR_OPAMP1OUTEN_Msk  (0x1UL << OPAMP_OPCR_OPAMP1OUTEN_Pos)       /*!< 0x00000080 */
#define OPAMP_OPCR_OPAMP1OUTEN      OPAMP_OPCR_OPAMP1OUTEN_Msk

#define OPAMP_OPCR_OPAMP2EN_Pos     (8U)
#define OPAMP_OPCR_OPAMP2EN_Msk     (0x1UL << OPAMP_OPCR_OPAMP2EN_Pos)          /*!< 0x00000100 */
#define OPAMP_OPCR_OPAMP2EN         OPAMP_OPCR_OPAMP2EN_Msk

#define OPAMP_OPCR_OPAMP2NSEL_Pos   (9U)
#define OPAMP_OPCR_OPAMP2NSEL_Msk   (0x3UL << OPAMP_OPCR_OPAMP2NSEL_Pos)        /*!< 0x00000600 */
#define OPAMP_OPCR_OPAMP2NSEL       OPAMP_OPCR_OPAMP2NSEL_Msk
#define OPAMP_OPCR_OPAMP2NSEL_0     (0x1UL << OPAMP_OPCR_OPAMP2NSEL_Pos)
#define OPAMP_OPCR_OPAMP2NSEL_1     (0x2UL << OPAMP_OPCR_OPAMP2NSEL_Pos)

#define OPAMP_OPCR_OPAMP2GAIN_Pos   (12U)
#define OPAMP_OPCR_OPAMP2GAIN_Msk   (0x3UL << OPAMP_OPCR_OPAMP2GAIN_Pos)        /*!< 0x00003000 */
#define OPAMP_OPCR_OPAMP2GAIN       OPAMP_OPCR_OPAMP2GAIN_Msk
#define OPAMP_OPCR_OPAMP2GAIN_0     (0x1UL << OPAMP_OPCR_OPAMP2GAIN_Pos)
#define OPAMP_OPCR_OPAMP2GAIN_1     (0x2UL << OPAMP_OPCR_OPAMP2GAIN_Pos)

#define OPAMP_OPCR_OPAMP2OUTEN_Pos  (15U)
#define OPAMP_OPCR_OPAMP2OUTEN_Msk  (0x1UL << OPAMP_OPCR_OPAMP2OUTEN_Pos)       /*!< 0x00008000 */
#define OPAMP_OPCR_OPAMP2OUTEN      OPAMP_OPCR_OPAMP2OUTEN_Msk

#define OPAMP_OPCR_OPAMP3EN_Pos     (16U)
#define OPAMP_OPCR_OPAMP3EN_Msk     (0x1UL << OPAMP_OPCR_OPAMP3EN_Pos)          /*!< 0x00010000 */
#define OPAMP_OPCR_OPAMP3EN         OPAMP_OPCR_OPAMP3EN_Msk

#define OPAMP_OPCR_OPAMP3NSEL_Pos   (17U)
#define OPAMP_OPCR_OPAMP3NSEL_Msk   (0x3UL << OPAMP_OPCR_OPAMP3NSEL_Pos)        /*!< 0x00060000 */
#define OPAMP_OPCR_OPAMP3NSEL       OPAMP_OPCR_OPAMP3NSEL_Msk
#define OPAMP_OPCR_OPAMP3NSEL_0     (0x1UL << OPAMP_OPCR_OPAMP3NSEL_Pos)
#define OPAMP_OPCR_OPAMP3NSEL_1     (0x2UL << OPAMP_OPCR_OPAMP3NSEL_Pos)

#define OPAMP_OPCR_OPAMP3GAIN_Pos   (20U)
#define OPAMP_OPCR_OPAMP3GAIN_Msk   (0x3UL << OPAMP_OPCR_OPAMP3GAIN_Pos)        /*!< 0x00300000 */
#define OPAMP_OPCR_OPAMP3GAIN       OPAMP_OPCR_OPAMP3GAIN_Msk
#define OPAMP_OPCR_OPAMP3GAIN_0     (0x1UL << OPAMP_OPCR_OPAMP3GAIN_Pos)
#define OPAMP_OPCR_OPAMP3GAIN_1     (0x2UL << OPAMP_OPCR_OPAMP3GAIN_Pos)

#define OPAMP_OPCR_OPAMP3OUTEN_Pos  (23U)
#define OPAMP_OPCR_OPAMP3OUTEN_Msk  (0x1UL << OPAMP_OPCR_OPAMP3OUTEN_Pos)       /*!< 0x00800000 */
#define OPAMP_OPCR_OPAMP3OUTEN      OPAMP_OPCR_OPAMP3OUTEN_Msk

#define OPAMP_OPCR_OPAMPLCK_Pos     (31U)
#define OPAMP_OPCR_OPAMPLCK_Msk     (0x1UL << OPAMP_OPCR_OPAMPLCK_Pos)          /*!< 0x80000000 */
#define OPAMP_OPCR_OPAMPLCK         OPAMP_OPCR_OPAMPLCK_Msk

/*****************  Bit definition for OPAMP_OPxCAL register  *****************/
#define OPAMP_OPxCAL_OPxCALDATN_Pos (0U)
#define OPAMP_OPxCAL_OPxCALDATN_Msk (0x1UL << OPAMP_OPxCAL_OPxCALDATN_Pos)      /*!< 0x0000003F */
#define OPAMP_OPxCAL_OPxCALDATN     OPAMP_OPxCAL_OPxCALDATN_Msk
#define OPAMP_OPxCAL_OPxCALDATN_0   (0x01UL << OPAMP_OPxCAL_OPxCALDATN_Pos)
#define OPAMP_OPxCAL_OPxCALDATN_1   (0x02UL << OPAMP_OPxCAL_OPxCALDATN_Pos)
#define OPAMP_OPxCAL_OPxCALDATN_2   (0x04UL << OPAMP_OPxCAL_OPxCALDATN_Pos)
#define OPAMP_OPxCAL_OPxCALDATN_3   (0x08UL << OPAMP_OPxCAL_OPxCALDATN_Pos)
#define OPAMP_OPxCAL_OPxCALDATN_4   (0x10UL << OPAMP_OPxCAL_OPxCALDATN_Pos)
#define OPAMP_OPxCAL_OPxCALDATN_5   (0x20UL << OPAMP_OPxCAL_OPxCALDATN_Pos)

#define OPAMP_OPxCAL_OPxCALDATP_Pos (8U)
#define OPAMP_OPxCAL_OPxCALDATP_Msk (0x1UL << OPAMP_OPxCAL_OPxCALDATP_Pos)      /*!< 0x00003F00 */
#define OPAMP_OPxCAL_OPxCALDATP     OPAMP_OPxCAL_OPxCALDATP_Msk
#define OPAMP_OPxCAL_OPxCALDATP_0   (0x01UL << OPAMP_OPxCAL_OPxCALDATP_Pos)
#define OPAMP_OPxCAL_OPxCALDATP_1   (0x02UL << OPAMP_OPxCAL_OPxCALDATP_Pos)
#define OPAMP_OPxCAL_OPxCALDATP_2   (0x04UL << OPAMP_OPxCAL_OPxCALDATP_Pos)
#define OPAMP_OPxCAL_OPxCALDATP_3   (0x08UL << OPAMP_OPxCAL_OPxCALDATP_Pos)
#define OPAMP_OPxCAL_OPxCALDATP_4   (0x10UL << OPAMP_OPxCAL_OPxCALDATP_Pos)
#define OPAMP_OPxCAL_OPxCALDATP_5   (0x20UL << OPAMP_OPxCAL_OPxCALDATP_Pos)

#define OPAMP_OPxCAL_OPxSYNC_Pos    (30U)
#define OPAMP_OPxCAL_OPxSYNC_Msk    (0x1UL << OPAMP_OPxCAL_OPxSYNC_Pos)         /*!< 0x40000000 */
#define OPAMP_OPxCAL_OPxSYNC        OPAMP_OPxCAL_OPxSYNC_Msk

#define OPAMP_OPxCAL_OPxCALEN_Pos   (31U)
#define OPAMP_OPxCAL_OPxCALEN_Msk   (0x1UL << OPAMP_OPxCAL_OPxCALEN_Pos)        /*!< 0x80000000 */
#define OPAMP_OPxCAL_OPxCALEN       OPAMP_OPxCAL_OPxCALEN_Msk
...
#define RCC_CFGR_MCO_HSI16                  (0x01000000U)                           /*!< HSI14 clock selected as MCO source */
...
#define RCC_CIR_HSI16RDYF_Pos               (5U)
#define RCC_CIR_HSI16RDYF_Msk               (0x1UL << RCC_CIR_HSI16RDYF_Pos)        /*!< 0x00000020 */
#define RCC_CIR_HSI16RDYF                   RCC_CIR_HSI16RDYF_Msk                   /*!< HSI16 Ready Interrupt flag */
...
#define RCC_CIR_HSI16RDYIE_Pos              (13U)
#define RCC_CIR_HSI16RDYIE_Msk              (0x1UL << RCC_CIR_HSI16RDYIE_Pos)       /*!< 0x00002000 */
#define RCC_CIR_HSI16RDYIE                  RCC_CIR_HSI16RDYIE_Msk                  /*!< HSI16 Ready Interrupt Enable */
...
#define RCC_APB1RSTR_I2C1RST                RCC_APB1RSTR_I2C1RST_Msk                /*!< I2C1 reset */
...
#define RCC_CSR_V15PWRRSTF_Pos              (23U)
#define RCC_CSR_V15PWRRSTF_Msk              (0x1UL << RCC_CSR_V15PWRRSTF_Pos)       /*!< 0x00800000 */
#define RCC_CSR_V15PWRRSTF                  RCC_CSR_V15PWRRSTF_Msk                  /*!< V1.5 power domain reset flag */
...
#define IS_TIM_OPM_INSTANCE(INSTANCE)\
  (((INSTANCE) == TIM1)    || \
   ((INSTANCE) == TIM2)    || \
   ((INSTANCE) == TIM3)    || \
   ((INSTANCE) == TIM16)   || \
